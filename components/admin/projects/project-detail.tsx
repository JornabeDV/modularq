...
import { ProjectHeader } from "../project-detail-sections/project-header";
import { ProjectInfoCards } from "../project-detail-sections/project-info-cards";
import { ProjectSpecs } from "../project-detail-sections/project-specs";
import { ProjectQuoteCard } from "../project-detail-sections/project-quote-card";
import { ProjectRentalCard } from "@/components/rentals/project-rental-card";
import { EditTaskDialog } from "../project-detail-sections/edit-task-dialog";
import { ActivateProjectDialog } from "../project-detail-sections/activate-project-dialog";
