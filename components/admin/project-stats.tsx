...
import { FolderOpen, Play, CheckCircle, Clock } from 'lucide-react'
...
export function ProjectStats({ totalProjects, activeProjects, completedProjects, planningProjects }: ProjectStatsProps) {
  return (
