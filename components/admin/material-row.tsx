...
export function MaterialRow({ material, onEdit, onDelete, isReadOnly = false }: MaterialRowProps) {
  ...
  return (
    <>
      <TableRow>
        ...
        <TableCell>
          {material.unitPrice ? (
            <span>${material.unitPrice.toLocaleString('es-AR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
          ) : (
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Estás a punto de eliminar el material <strong>{material.name}</strong> ({material.code}).
